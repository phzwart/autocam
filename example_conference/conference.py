...
class RepresentationLearningConferenceConference:
    """A conference for representation learning experiments."""

    def __init__(self):
        """Initialize the conference."""
        self.name = "Representation_Learning_Conference"
    ...
    def _setup_sessions(self):
        ...
        self.parallel_sessions["Processing_Pipelines"] = {
            ...
            "working_groups": {
                ...
                "3D_Processing": {
                    "name": "3D_Processing",
                    "description": "3D volume processing pipeline",
                    "participant_names": [
                        "encoder_3d",
                        "transformer_3d",
                        "classifier_3d",
        ...
        self.parallel_sessions["Model_Comparison"] = {
            ...
            "working_groups": {
                "Encoder_Group": {
                    ...
                    "participant_names": ["encoder_2d", "encoder_3d"],
                    "participants": [],  # Will be populated when models are registered
                },
                "Classifier_Group": {
                    "name": "Classifier_Group",
                    "description": "Classification models",
                    "participant_names": ["classifier_2d", "classifier_3d"],
                    "participants": [],  # Will be populated when models are registered
                },
            },
        }
...
conference = RepresentationLearningConferenceConference()

if __name__ == "__main__":
    # Example usage
    print("Conference: Representation_Learning_Conference")
    ...
    print("\nSession: Processing_Pipelines")

    print("  Working Group: 2D_Processing - 2D image processing pipeline")
    print(f"    Participants: {['encoder_2d', 'transformer_2d', 'classifier_2d']}")

    print("  Working Group: 3D_Processing - 3D volume processing pipeline")
    print(f"    Participants: {['encoder_3d', 'transformer_3d', 'classifier_3d']}")

    print("\nSession: Model_Comparison")

    print("  Working Group: Encoder_Group - Feature extraction models")
    print(f"    Participants: {['encoder_2d', 'encoder_3d']}")

    print("  Working Group: Classifier_Group - Classification models")
    print(f"    Participants: {['classifier_2d', 'classifier_3d']}")
